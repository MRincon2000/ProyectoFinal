 ...
 * @author usuario
 */
public class Escena4 extends AnimationTimer implements Vista  {
private Pane panel;
...
public Escena4(Controlador4 c, int p1, int p2) {
    this.p1=p1;
    this.p2=p2;
 ...
 this.anim2= new Image("Imagenes/va.png");
    ...
    escena.setOnKeyPressed(
        ...
        this.obstaculos=new Obstaculo[26];
    obstaculos[0]=new Pared (80,20,85,90);
    obstaculos[1]=new Pared (20,55,165,55);
    ...
    obstaculos[11]=new Cactus ( 100,500,30);
    obstaculos[12]=new Cactus( 190, 150,30);
    obstaculos[13]=new Pared (20,407,0,0);
    obstaculos[14]=new Pared (20,100,616,0);
    obstaculos[15]=new Pared (350,20,0,407);
    obstaculos[16]=new Pared (180,20,456,407);
    obstaculos[17]=new Pared (616,20,10,0);
    obstaculos[18]=new Cactus(500, 500,30);
    obstaculos[19]=new Cactus (680, 150,30);
    obstaculos[20]=new Cactus( 300, 500,30);
    obstaculos[21]=new Pared (20,207,616,200);
    obstaculos[22]=new Pared (5,580,750,0);
    obstaculos[23]=new Pared (154,5,626,0);
    obstaculos[24]=new Pared (750,5,0,575);
    obstaculos[25]=new Pared (5,168,0,407);    
       ...
       if(this.obstaculos[z] instanceof Pared){
        ...
        if(interg2.getLayoutBounds().getWidth()!=-1 && tanque2.ismA()){
            ...
            break;
                ...
                int numeroR =(int) (Math.random() * 7) + 1;   
                ...
                if(interp2.getLayoutBounds().getWidth()!= -1 && !tanque2.isPoder()){
                    ...
                    int numeroS =(int) (Math.random() * 7) + 1;   
                ...
                if(inter.getLayoutBounds().getWidth()!= -1){
                    System.out.println(tanque.getDanio());
